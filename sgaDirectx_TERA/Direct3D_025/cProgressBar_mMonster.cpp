...
void cProgressBar_mMonster:: Setup()
{
	...
	D3DXCreateTextureFromFileEx(
		g_pD3DDevice, "Tera/UI/ProgressBar_Monster/GageMmonster_bar.tga",
	...
	//HP바 
	D3DXCreateTextureFromFileEx(
		g_pD3DDevice, "Tera/UI/ProgressBar_Monster/GageMmonster_Hp.tga",
		D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT_NONPOW2, D3DX_DEFAULT,
		0, D3DFMT_UNKNOWN, D3DPOOL_MANAGED,
		D3DX_FILTER_NONE, D3DX_DEFAULT, 0,
...
void cProgressBar_mMonster::Render()
{
	if (!m_bDeath)
	{
		...
		m_pProgressBar_Sprite->Draw(m_pProgressBar_Texture,
			&m_rcProgressBar,
			&D3DXVECTOR3(0, 0, 0),
			&D3DXVECTOR3(m_rcProgressBar.left + 235, m_rcProgressBar.top + 105, 0),
		...
		m_pHP_Sprite->Draw(m_pHP_Texture,
			&m_rcHP,
			&D3DXVECTOR3(0, 0, 0),
			&D3DXVECTOR3(m_rcProgressBar.left + 239, m_rcProgressBar.top + 107, 0),
			D3DCOLOR_XRGB(255, 255, 255));
		m_pHP_Sprite->End();
	}
